	...
	render() {
		return (
			<div className="container2">
				...
				<div>
					<h1 style={{ fontSize: "45px" }}>Video rooms</h1>
					<p style={{ fontWeight: "200" }}>Video rooms for unlimited online learning.</p>
				</div>
				...
				<div style={{
					...
					<Input placeholder="Room" onChange={e => this.handleChange(e)} />
